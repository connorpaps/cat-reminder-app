...
## 2026-08-02 19:02 — `9d822ff`
**Initial commit: Caltendar Cat Reminder App**

  - .agents/skills/dev/SKILL.md
  - .agents/skills/dev/release.md
  - .agents/skills/dev/roll.md
  - .agents/skills/google-calendar-automation/SKILL.md
  - .agents/skills/pixel-art-sprites/SKILL.md
  - .agents/skills/pixel-art-sprites/references/patterns.md
  - .agents/skills/pixel-art-sprites/references/sharp_edges.md
  - .agents/skills/pixel-art-sprites/references/validations.md
  ...
  - .claude/skills/google-calendar-automation/SKILL.md
  - .env.example
  - .gitignore
  - README.md
  - assets/Idle.png
  - assets/Running.png
  - assets/textbox.png
  - cat_reminder_master_project_spec_v1_3.md
  ...
  - pnpm-lock.yaml
  - pnpm-workspace.yaml
  - public/assets/cats/default/idle.png
  - public/assets/cats/default/manifest.json
  - public/assets/cats/default/running.png
  - public/assets/textbox/textbox.png
  ...
  - src/main/windows/window-utils.ts
  ...
  - src/shared/ipc.ts
  - src/shared/reminders/recurrence.ts
  ...
  - tests/shared/calendar-sync.test.ts
  - tests/shared/queue.test.ts
  - tests/shared/recurrence.test.ts
